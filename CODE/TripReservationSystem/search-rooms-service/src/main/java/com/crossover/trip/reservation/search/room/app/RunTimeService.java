package com.crossover.trip.reservation.search.room.app;

import org.apache.camel.main.Main;

import com.crossover.trip.reservation.routes.SearchRoomRouteBuilder;

/**
 * Create a new runtime instance of the RoomService.
 *
 */
public class RunTimeService {
	...
	private Main main;
	  ...
	  public void boot(String port) throws Exception {
	    ...
	    // add routes
	    main.addRouteBuilder(new SearchRoomRouteBuilder());
