...
import com.crossover.trip.reservation.routes.SearchTripPackagesRouteBuilder;

/**
 * Create a new runtime instance of the SearchTripPackageService.
 *
 */
public class RunTimeService {
	...
	private Main main;
	  ...
	  public void boot(String port) throws Exception {
	    ...
	    // add routes
	    main.addRouteBuilder(new SearchTripPackagesRouteBuilder());
