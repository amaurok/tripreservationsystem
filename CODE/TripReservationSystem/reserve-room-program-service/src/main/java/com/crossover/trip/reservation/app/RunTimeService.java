...
import com.crossover.trip.reservation.routes.ReservationsRouteBuilder;

/**
 * Create a new runtime instance of the ReservationsService.
 *
 */
public class RunTimeService {
	...
	private Main main;
	  ...
	  public void boot(String port) throws Exception {
	    ...
	    // add routes
	    main.addRouteBuilder(new ReservationsRouteBuilder());
