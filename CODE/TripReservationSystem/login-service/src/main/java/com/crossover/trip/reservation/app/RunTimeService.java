...
import com.crossover.trip.reservation.routes.LoginRouteBuilder;

/**
 * Create a new runtime instance of the LoginService.
 *
 */
public class RunTimeService {
	...
	private Main main;
	  ...
	  public void boot(String port) throws Exception {
	    ...
	    // add routes
	    main.addRouteBuilder(new LoginRouteBuilder());
