...
import com.crossover.trip.reservation.routes.SearchReservationsHistoryRouteBuilder;

/**
 * Create a new runtime instance of the SearchReservationsHistoryService.
 *
 */
public class RunTimeService {
	...
	private Main main;
	  ...
	  public void boot(String port) throws Exception {
	    ...
	    // add routes
	    main.addRouteBuilder(new SearchReservationsHistoryRouteBuilder());
